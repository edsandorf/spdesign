...
remotes::install_github("edsandorf/spdesign", ref = "v0.0.7-dev")
```
...
We would also like to acknowledge all those who have contributed with bug reports: Gabriele Iannaccone, Petr Mariel, Julian Sagebiel, Huu-Luat Do, Eduardo Barbosa
