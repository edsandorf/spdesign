...
We can specify a Bayesian prior by specifying the distribution of the prior. For example, `U(-1, 1)` means that we allow the prior to follow a uniform distribution between -1 and 1. 
